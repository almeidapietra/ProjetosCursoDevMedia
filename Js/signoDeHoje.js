...
const retorna_signo = (signos, data) => {
    ...
    for (const signo of signos ){
        ...
        //receber o valor "or" se for o signo de capricornio - or: a data está parcialmente dentro do range / and: a data está completamente dentro do range. (resolve bg de capricórnio)
